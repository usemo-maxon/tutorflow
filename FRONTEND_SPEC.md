# easy4tutor — специфікація роботи frontend

Цей документ описує поведінку клієнтської частини easy4tutor. Він не визначає конкретний backend-фреймворк, але встановлює контракти, стани й правила, яких має дотримуватися frontend.
